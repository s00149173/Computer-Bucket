...
namespace computerbucket
{
    ...
    public partial class computerbucketEntities : DbContext
    {
        ...
        public virtual ObjectResult<selectPartCompatible_Result> selectPartCompatible(Nullable<int> motherboardID, Nullable<int> categoryID)
        {
            var motherboardIDParameter = motherboardID.HasValue ?
                new ObjectParameter("motherboardID", motherboardID) :
                new ObjectParameter("motherboardID", typeof(int));
    
            var categoryIDParameter = categoryID.HasValue ?
                new ObjectParameter("categoryID", categoryID) :
                new ObjectParameter("categoryID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<selectPartCompatible_Result>("selectPartCompatible", motherboardIDParameter, categoryIDParameter);
        }
    }
}
